...
class JobApplicationDAO:
    ...
    async def create_application(self, position_name: str, applicant_id: int) -> JobApplication:
        try:
    ...
    async def update_application(self, application_id: int, **kwargs) -> Optional[JobApplication]:
        try:
